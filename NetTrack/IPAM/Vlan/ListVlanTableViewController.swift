//
//  ListVlanTableViewController.swift
//  NetTrack
//
...
class ListVlanTableViewController: UITableViewController, DatabaseListener {
    
    let SECTION_VLAN = 0
    let CELL_VLAN = "vlanCell"
    
    var allVlans: [Vlan] = []
    
    var listenerType: ListenerType = .vlan
